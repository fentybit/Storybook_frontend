        ...
        return (
            <div>
                ...
                <Switch>
                    ...
                    <Route path={`${this.props.url}/photos`} render={(routerProps) => <Summary {...routerProps} categories={this.props.categories} events={this.props.categories} />} />
                    ...
                    {/* working */}
                    <Route path={`${this.props.url}/:categoryId`} render={(routerProps) => <CategorySummary {...routerProps} events={this.props.events} token={this.props.token} />} />
